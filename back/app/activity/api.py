...
from activity.schema import ActivityCreate, ActivityRead, ConfirmRequest, PhotoUploadResponse
from activity.service import confirm_schedule, create_activity_direct, get_activity, upload_photos
